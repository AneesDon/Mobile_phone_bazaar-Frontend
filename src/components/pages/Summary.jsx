...
const onCloseModal = () => setOpen(false);
      ...
      <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
        <section aria-labelledby="cart-heading" className="rounded-lg bg-white lg:col-span-8">
          ...
          <div className=' divide-y divide-solid *:py-7'>
            ...
            { method === 'card' ?  <p className='text-lg font-semibold'>Card(.... .... .... .007)</p> : null  }
            { method === 'upi' ?  
            <>
            <p>UPI Payment, Please Scan this QR code to pay your bill of 1000/-</p>
  ...
  <h2 className=' px-32 py-5 font-semibold text-xl'>Your Order Is Confirmed</h2>
  <p className=' text-center'>Thank You For Shopping! Your Order Will Be </p><p className=' text-center'>Delivered To Your Doorstep Soon.</p>
  <Link to={'/'}>
