...
function ProductDetails() {
  ...
  const handlePostReview = (e) => {
    ...
    console.log(token);
    axios
      .post("/api/product-management/product-review/", {
...
useEffect(()=>{
  ...
  axios.get(`/api/product-management/product/${productDetails?.brand}`)
  .then((res) => {
      ...
      <Container>
        ...
        >
          <ul className=' *: py-3'>
            ...
            <h3 className=''> {productDetails?.product_features?.color}</h3>
            ...
            <h3> {productDetails?.product_features?.rear_camera}MP +{" "}
              {productDetails?.product_features?.front_camera}MP</h3>
        ...
        >
          ...
          <div class="add-review" className=" py-5">
            ...
            ></textarea>
            <button className="text-center py-3 px-7 bg-black text-white rounded-lg hover:bg-gray-700" type='submit'>
              submit
            </button>
            </form>
          </div>
